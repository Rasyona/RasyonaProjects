...
public class KullaniciBean implements Serializable {
    ...
    //Kullanıcı adının email şeklinde girilmesi sağlanmış.
    //Eğer e-mail formatında yazılmamış ise hata verir.
    @Pattern(regexp = ".+@.+\\.[a-z]+",
    ...
    // Eklenecek silinece Blog, Girdi ve Yorumlar iççin
    // kullanılan yardımcı üye değişkenler tanımlanmış.
